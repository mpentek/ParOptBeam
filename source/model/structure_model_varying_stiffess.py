...
class StraightBeam(object):
    ...
    def update_stiffness_values(self, iy_new, iz_new, it_new, asz_new, asy_new):
        self.parameters["intervals"][0]['c_a_sy'] = asy_new
        self.parameters["intervals"][0]['c_a_sz'] = asz_new
        self.parameters["intervals"][0]['c_iy'] = iy_new
        self.parameters["intervals"][0]['c_iz'] = iz_new
        self.parameters["intervals"][0]['c_it'] = it_new
        # update the element values 
        self.initialize_elements()
        # update the stiffness and damping matrics 
        self.calculate_global_matrices()
