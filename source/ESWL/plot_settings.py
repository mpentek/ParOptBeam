...
def get_params(width=16, height=10, use_tex = True, minor_ticks = True, present =False):
    ''' 
    ...
    params = {
            ...
            # LINES
            # ***********************
            'lines.linewidth': 0.7,#lwidth,#0.7
            'lines.markersize': 1,
