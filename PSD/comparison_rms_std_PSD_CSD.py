...
def cross_spectral_density(x,y, time_series, subtract_mean, use_fs = True, use_nfft = True,
                             nperseg = 2048, window_type):
    '''
    ...
    f, csd_raw = csd(x,y, fs=fs,nfft=nfft, window = win, nperseg=nperseg)
