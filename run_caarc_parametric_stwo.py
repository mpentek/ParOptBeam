        ...
        for available_model in parametric_run['project_params']:
            ...
            for n_el in [2]: #[60, 30, 15, 3, 2, 1]:
                ...
                if parameters["model_parameters"]["name"][:-1] == "CaarcBeamCont":
                    parameters["optimization_parameters"]["adapt_for_target_values"]["density_for_total_mass"] = 38880000.0 *1.1
                else:
                    parameters["optimization_parameters"]["adapt_for_target_values"]["density_for_total_mass"] = 38880000.0 *1.15
                ...
                for idx, parameter in enumerate(parameters["analyses_parameters"]["runs"]):
                    if parameter["type"] == "dynamic_analysis":
                        ...
                        load_file_path = load_file + '_stwo' + '.npy'
